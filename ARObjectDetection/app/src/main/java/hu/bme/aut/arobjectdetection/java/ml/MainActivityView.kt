...
import hu.bme.aut.arobjectdetection.java.common.helpers.SnackbarHelper
import hu.bme.aut.arobjectdetection.java.common.samplerender.SampleRender

/**
 * Wraps [com.google.ar.core.examples.java.ml.R.layout.activity_main] and controls lifecycle operations for [GLSurfaceView].
 */
